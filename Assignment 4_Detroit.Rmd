...
```{r}
Detroit_parking <- oe_read("network2/bbbike_detroit.pbf",
...
```{r}
r5r_core <- setup_r5("network2", verbose = FALSE)
```
...
```{r}
Detroit_kindergarten <- oe_read("network2/bbbike_detroit.pbf",
                   provider = "openstreetmap_fr",
                   download_directory = "network2",
                   layer = "points",
                   quiet = TRUE) %>%
...
```{r}
Detroit_clinic <- oe_read("network2/bbbike_detroit.pbf",
                   provider = "openstreetmap_fr",
                   download_directory = "network2",
                   layer = "points",
                   quiet = TRUE) %>%
